...
const Login = ({ onLogin, onLangChange, initialLang = 'fr', onBack }) => {
...
<div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans">
      ...
      <div className="fixed top-6 left-0 right-0 flex justify-between items-center px-6 max-w-6xl mx-auto">
        ...
        <div className="flex gap-2 border-r border-slate-200 pr-4">
          ...
          <button onClick={() => handleLangChange('en')} className={`text-[10px] font-bold ${lang === 'en' ? 'text-emerald-500' : 'text-slate-300'}`}>EN</button>
        </div>
      </div>
